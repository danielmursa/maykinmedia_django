...
ROOT_URLCONF = "maykinmedia_django.urls"
...
# Add these settings if they are not already in your settings.py
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": os.path.join(BASE_DIR, "maykinmedia_logger.log"),
            "formatter": "verbose",
        },
        "mail_admins": {
            "level": "ERROR",
